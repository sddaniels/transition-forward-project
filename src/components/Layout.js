...
export default class Body extends React.Component {
  render() {
    ...
    const description =
      ...
      _.get(this.props, 'pageContext.site.siteMetadata.metaDescription');
    const { origin } = this.props.pageContext.site.siteMetadata;
    const location = origin + this.props.location.pathname;
    const ogImage = `${origin}/images/tfp-opengraph.jpg`;
